...
print("="*80)
print("\nThis will retrain models from scratch with hyperparameter optimization")
...
if n_trials_input == '':
    ...
    try:
        ...
        if n_trials < 10:
            print("Minimum 10 trials required. Setting to 10.")
            n_trials = 10
        elif n_trials > 200:
            print("Maximum 200 trials recommended. Setting to 200.")
            n_trials = 200
    except:
